...
void loop() {
  ...
  for (int i=word_length - 1; i >= 0; i--) {
    elapsed_time = 0;
    while (elapsed_time < 0.25 * start_bit_duration) {
      Serial.println(digitalRead(LED_BUILTIN));
      delay(bit_sampling_time);
      elapsed_time += bit_sampling_time;
    }
    first_level = digitalRead(LED_BUILTIN);
    elapsed_time = 0;
    ...
    second_level = digitalRead(LED_BUILTIN);
    elapsed_time = 0;
    while(elapsed_time < 0.25 * start_bit_duration) {
      Serial.println(digitalRead(LED_BUILTIN));
      delay(bit_sampling_time);
    ...
    switch (first_level) {
      case 0:
        switch (second_level) {
          case 0:
            Serial.println("No trannsition: 00");
            break;
          case 1:
            // Got a zero.
            Serial.print("bit 2^");
            ...
            break;
          default:
            Serial.print("This can't happen: second_level[");
            Serial.print(i);
            Serial.print("] = ");
      ...
      case 1:
        switch (second_level) {
          case 0:
            ...
            break;
          case 1:
            Serial.println("No transition: 11");
            break;
          default:
            Serial.print("This can't happen: second_level[");
            Serial.print(i);
        ...
        break;
      default:
        Serial.print("This can't happen: first_level[");
        Serial.print(i);
        Serial.print("] = ");
